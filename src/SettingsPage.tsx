...
export default function SettingsPage({
  ...
  const [dailyReport,setDailyReport]=useState(()=>{try{return {...{enabled:false,recipient:"",sendTime:"18:00",serviceId:"service_rxuyna6",templateId:"template_hy6e8vi",publicKey:"mvJ716sG3Lc0UiHJL"},...(JSON.parse(localStorage.getItem("printmanager.daily-report")||"null")||{})}}catch{return {enabled:false,recipient:"",sendTime:"18:00",serviceId:"service_rxuyna6",templateId:"template_hy6e8vi",publicKey:"mvJ716sG3Lc0UiHJL"}}});
      ...
      <section className="settings-grid">
        <div>
          ...
          <section className="settings-card daily-report-settings">
            ...
            <p className="accounting-rule-hint">The report will include collections, expenses, unpaid jobs, completed jobs and cash remaining. Reports send while PrintAcad is open and online.</p><button type="button" className="secondary-button" onClick={saveDailyReport}><Mail/>Save report schedule</button><button type="button" className="secondary-button" onClick={()=>void testDailyReport()}><Mail/>Send test report</button>
          </section>
