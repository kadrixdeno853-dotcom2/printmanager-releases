  ...
  return <div className="setup-page">
    ...
    <div className="setup-card">
      ...
      {step === 0 && <form onSubmit={next} className="setup-content">
        <div className="setup-symbol"><Building2 size={25} /></div><p className="eyebrow">WELCOME TO PRINTMANAGER</p><h1>Lets set up your business</h1><p className="setup-copy">This information will appear on your quotations, invoices and receipts. You can change it later.</p>
