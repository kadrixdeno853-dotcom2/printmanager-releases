  ...
  return <div className="setup-page">
    ...
    <div className="setup-card">
      ...
      {step === 0 && <form onSubmit={next} className="setup-content">
        <div className="setup-symbol"><Building2 size={25} /></div><p className="eyebrow">WELCOME TO PRINTMANAGER</p><h1>Letâ€™s set up your business</h1><p className="setup-copy">This information will appear on your quotations, invoices and receipts. You can change it later.</p>
      ...
      {step === 1 && <form onSubmit={next} className="setup-content">
        <div className="setup-symbol"><ShieldCheck size={25} /></div><p className="eyebrow">OWNER ACCOUNT</p><h1>Who manages this business?</h1><p className="setup-copy">Youâ€™ll be the first owner. Secure sign-in credentials will be added in the user-account step.</p>
